#
#  Be sure to run `pod spec lint CLLocationCLExtensions.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.license      = 'The original JavaScript implementation is © 2002-2006 Chris Veness.'
